...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(
        KC_ESC,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,             KC_PSCR, TO(2), KC_PAUS, \
...
const struct color ledmaps[][MATRIX_ROWS * MATRIX_COLS] = {
    [0] = {
        WHITE,  WHITE,   WHITE,   WHITE,   WHITE,   WHITE,   WHITE,   WHITE,   WHITE,   WHITE,   WHITE,  WHITE,  WHITE,             WHITE, BLUE,  WHITE, \
    ...
    [2] = {
        GREEN,  WHITE,   WHITE,   WHITE,   WHITE,   WHITE,   WHITE,   WHITE,   WHITE,   WHITE,   WHITE,  WHITE,  WHITE,             BLUE,  BLUE,  BLUE, \
